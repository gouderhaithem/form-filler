...
{!isExtension()&&<button className="fill" onClick={fill} disabled={!ready||busy}><Sparkles size={18}/>{busy?'Filling your form…':'Generate & fill'}<ArrowUpRight size={18}/></button>}
      ...
      <footer><span><span className="status-dot"/> Your browser, your test data</span><a className="welcome-link" href="./welcome.html" target="_blank" rel="noreferrer">Welcome guide ↗</a><span>v0.9</span></footer>
    </main>
