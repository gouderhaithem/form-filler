...
export function GeminiPanel() {
  ...
  return <section className="gemini-panel" aria-label="Gemini settings">
    ...
    <p className="helper">Gemini reads field labels and prepares relevant words and phrases as forms appear, including dialogs and pages rendered later. Click Fill to use ready suggestions, or wait for AI if they are still loading. A quota or rate-limit error switches to local data.</p>
